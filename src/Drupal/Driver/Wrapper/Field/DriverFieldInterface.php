...
/**
 * Defines a Driver field wrapper that holds information about a Drupal field.
 */
interface DriverFieldInterface {
  ...
  /**
   * Gets the particular field definition.
   *
   * For D7 that's the field instance definition,
   * for D8 that;s the  field_storage_config.
   *
   * @return object|array
   *   the field definition.
   */
